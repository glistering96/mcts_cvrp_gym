...
class CVRPEnv(gym.Env):
    ...
    def __init__(self, num_depots, num_nodes, step_reward=False, render_mode=None, training=True, seed=1, data_path='./data'):
    ...
    def reset(self, seed=None, options=None):
        ...
        self._visiting_seq.append(0)
        self._available = np.ones(self.action_size, dtype=bool)
        self._available[0] = False  # for the initial depot
    ...
    def render(self):
        ...
        for i, (x, y) in enumerate(self.scaled_xy):
            ...
            # Round up demand to 3 decimal points
